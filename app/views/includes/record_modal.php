    ...
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>record_add.php">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>record_edit.php">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>record_delete.php">
