    ...
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>cashadvance_add.php">
          		  <div class="form-group">
                  	<label for="employee" class="col-sm-3 control-label">Cueilleur ID</label>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>cashadvance_edit.php">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content" style="height: 60vh;">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="<?php echo Flight::get('flight.base_url')?>cashadvance_delete.php">
            		<input type="hidden" class="caid" name="id">
